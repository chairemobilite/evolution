...
export const groupedPersonUsualSchoolPlaceGeography: any =
    householdMembersWidgets.groupedPersonUsualSchoolPlaceGeography;
...
export const householdWouldLikeToParticipateInOtherSurveys: any =
    endWidgets.householdWouldLikeToParticipateInOtherSurveys;
...
export const buttonSaveNextSection = getButtonValidateAndGotoNextSection(
    'survey:SaveAndContinue',
    widgetFactoryOptions
);

export const buttonSaveNextSection2 = getButtonValidateAndGotoNextSection(
    'survey:SaveAndContinue',
    widgetFactoryOptions
);
...
export const buttonCompleteInterview = getButtonValidateAndGotoNextSection(
    'survey:CompleteInterview',
    widgetFactoryOptions
);
