...
const sections: { [sectionName: string]: SectionConfig } = {
    ...
    personsTrips: {
        ...
        completionConditional: function (interview) {
            ...
            return (
                ...
                !persons.some((person) => !helper.profileInfoForPersonComplete(person, interview))
            );
        },
        repeatedBlock: {
            iterationRule: {
    ...
    travelBehavior: {
        ...
        completionConditional: function (interview) {
            ...
            if (_isBlank(household.residentialPhoneType) || _isBlank(household.didAlsoRespondByPhone)) {
                return false;
            }
            return true;
        },
