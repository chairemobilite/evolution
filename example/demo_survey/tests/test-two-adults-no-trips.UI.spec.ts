...
test.beforeAll(async ({ browser }) => {
  context.page = await testHelpers.initializeTestPage(
    browser,
    context.objectDetector,
  );
});
/* Test the survey with a one-person household */
surveyTestHelpers.startAndLoginAnonymously({
  context,
  title: "Démo",
  hasUser: false,
});
...
testHelpers.inputStringTest({
  context,
  path: "household.persons.${personId[0]}.nickname",
  value: "bob",
});
testHelpers.inputStringTest({
  context,
  path: "household.persons.${personId[0]}.age",
  value: "30",
});
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[0]}.gender",
  value: "male",
});
testHelpers.inputSelectTest({
  context,
...
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[0]}.transitPassOwner",
  value: "no",
});
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[0]}.bikesharingMember",
  value: "yes",
});
testHelpers.inputRadioTest({
  context,
...
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[0]}.cellphoneOwner",
  value: "yes",
});
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[0]}.didTripsOnTripsDate",
  value: "no",
});
...
testHelpers.inputStringTest({
  context,
  path: "household.persons.${personId[1]}.nickname",
  value: "alice",
});
testHelpers.inputStringTest({
  context,
  path: "household.persons.${personId[1]}.age",
  value: "60",
});
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[1]}.gender",
  value: "female",
});
testHelpers.inputSelectTest({
  context,
...
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[1]}.drivingLicenseOwnership",
  value: "yes",
});
testHelpers.inputRadioTest({
  context,
...
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[1]}.transitPassOwner",
  value: "no",
});
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[1]}.bikesharingMember",
  value: "yes",
});
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[1]}.hasDisability",
  value: "no",
});
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[1]}.cellphoneOwner",
  value: "no",
});
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[1]}.didTripsOnTripsDate",
  value: "no",
});
...
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[0]}.workOnTheRoad",
  value: false,
});
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[0]}.usualWorkPlaceIsHome",
  value: true,
});
testHelpers.inputNextButtonTest({
  context,
  text: "Save and continue",
  nextPageUrl: "/survey/travelBehavior",
});
...
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[1]}.workOnTheRoad",
  value: false,
});
testHelpers.inputRadioTest({
  context,
  path: "household.persons.${personId[1]}.usualWorkPlaceIsHome",
  value: true,
});
testHelpers.inputNextButtonTest({
  context,
