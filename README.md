...
| `yarn test:python`          | `pytest` in `evolution-generator`                              |
| `yarn lint` / `yarn format` | ESLint / Prettier across all packages                          |
...
- General guidelines for contributions: [docs/development/README.md](docs/development/README.md).
