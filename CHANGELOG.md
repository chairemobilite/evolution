...
- **Generator conditional hidden values**: In the `Conditionals` Excel sheet, you can now set an optional `hidden_value` so a value is applied when the conditional hides the question (fixes [#979](https://github.com/chairemobilite/evolution/issues/979)).
