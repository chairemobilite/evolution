...
describe('downloadSurveyQuestionnaireListTxt route', () => {
    it('Should return the English questionnaire file if lang is en', async () => {
        ...
        getAbsolutePathMock.mockReturnValueOnce('/mocked/path/references/questionnaire_list_en.txt');
        ...
        expect(getAbsolutePathMock).toHaveReturnedWith('/mocked/path/references/questionnaire_list_en.txt');
    });

    it('Should return the French questionnaire file if lang is fr', async () => {
        fileExistsAbsoluteMock.mockReturnValueOnce(true);
        getAbsolutePathMock.mockReturnValueOnce('/mocked/path/references/questionnaire_list_fr.txt');
        ...
        expect(getAbsolutePathMock).toHaveReturnedWith('/mocked/path/references/questionnaire_list_fr.txt');
    });
