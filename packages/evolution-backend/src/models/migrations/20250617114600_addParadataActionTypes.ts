...
const newEnumValue1 = 'interview_open';
const newEnumValue2 = 'language_change';

export async function up(knex: Knex): Promise<unknown> {
    await knex.raw(`ALTER TYPE ${eventTypeEnumName} ADD VALUE '${newEnumValue1}';`);
    return knex.raw(`ALTER TYPE ${eventTypeEnumName} ADD VALUE '${newEnumValue2}';`);
}
