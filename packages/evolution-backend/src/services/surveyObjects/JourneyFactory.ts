 ...
 *
 * @param {Pick<QuestionnaireJourney, 'personDidTrips' | 'personDidTripsConfirm'>} attributes Journey fields from the response
 ...
 */
const didTripsFromQuestionnaire = (
    attributes: Pick<QuestionnaireJourney, 'personDidTrips' | 'personDidTripsConfirm'>,
    skipTripDiary: boolean
): unknown => {
    if (skipTripDiary) {
