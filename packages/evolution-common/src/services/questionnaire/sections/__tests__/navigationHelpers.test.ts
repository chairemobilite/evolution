...
describe('getLastVisitedSection', () => {
    ...
    it('should return undefined when there are no section actions', () => {
        const interview = { response: { _sections: { _actions: [] } } } as unknown as UserRuntimeInterviewAttributes;

        expect(getLastVisitedSection({ interview })).toBeUndefined();
    });

    it('should return undefined when _actions does not exist', () => {
        const interview = { response: { _sections: {} } } as unknown as UserRuntimeInterviewAttributes;

        expect(getLastVisitedSection({ interview })).toBeUndefined();
    });

    it('should return undefined when _sections does not exist', () => {
        const interview = { response: {} } as unknown as UserRuntimeInterviewAttributes;
...
describe('isSectionCompleted', () => {
    it('should return true when a section is marked as completed', () => {
        const interview = { response: { _sections: { section1: { _isCompleted: true } } } } as unknown as UserRuntimeInterviewAttributes;
    ...
    it('should return false when a section is not marked as completed', () => {
        const interview = { response: { _sections: { section1: { _isCompleted: false } } } } as unknown as UserRuntimeInterviewAttributes;
    ...
    it('should return true when a section with iteration context is marked as completed', () => {
        const interview = {
            response: {
                _sections: { section1: { _isCompleted: true, 'person/uuid': { _isCompleted: true }, 'person/uuid2': { _isCompleted: false } } }
            }
        } as unknown as UserRuntimeInterviewAttributes;
    ...
    it('should return false when a section with iteration context is not marked as completed', () => {
        const interview = {
            response: {
                _sections: { section1: { _isCompleted: false, 'person/uuid': { _isCompleted: true }, 'person/uuid2': { _isCompleted: false } } }
            }
        } as unknown as UserRuntimeInterviewAttributes;
    ...
    it('should return false when _isCompleted is undefined', () => {
        const interview = { response: { _sections: { section1: {} } } } as unknown as UserRuntimeInterviewAttributes;
    ...
    it('should return false when specific iteration context is not defined', () => {
        const interview = {
            response: { _sections: { section1: { _isCompleted: true, 'person/uuid': { _isCompleted: true } } } }
        } as unknown as UserRuntimeInterviewAttributes;
...
describe('isIterationContextStarted', () => {
    ...
    it('should return true when iteration context has started', () => {
        const interview = {
            response: { _sections: { section1: { 'person/uuid': { _startedAt: 1234567890 } } } }
        } as unknown as UserRuntimeInterviewAttributes;
    ...
    it('should return false when iteration context has not started', () => {
        const interview = { response: { _sections: { section1: { 'person/uuid': {} } } } } as unknown as UserRuntimeInterviewAttributes;
    ...
    it('should return true when any section for the iteration context has started', () => {
        const interview = {
            response: {
                _sections: { section1: { 'person/uuid': { _startedAt: 1234567890 } }, section2: { 'person/uuid2': { _startedAt: 9876543210 } } }
            }
        } as unknown as UserRuntimeInterviewAttributes;
    ...
    it('should return false when no sections for the iteration context have started', () => {
        const interview = {
            response: {
                _sections: { section1: { 'person/uuid': { _startedAt: 1234567890 } }, section2: { 'person/uuid2': { _startedAt: 1234567890 } } }
            }
        } as unknown as UserRuntimeInterviewAttributes;
