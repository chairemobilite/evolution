...
describe('Simple direct navigation, each section in nav bar', () => {
    ...
    describe('Navigate function', () => {
        ...
        test('should navigate to the next section forward', () => {
            ...
            const nextSectionResult = navigationService.navigate(testInterview, _cloneDeep(currentSectionData), 'forward');
            expect(nextSectionResult).toEqual({
                targetSection: {
                    sectionShortname: expectedSection,
                    iterationContext: undefined
        ...
        test('should navigate to the next section backward', () => {
            ...
            // Navigate to specific section
            const nextSectionResult = navigationService.navigate(testInterview, _cloneDeep(currentSectionData), 'backward');
            expect(nextSectionResult).toEqual({
                targetSection: {
                    sectionShortname: expectedSection,
                    iterationContext: undefined
    ...
    describe('Navigate function', () => {
        ...
        test('should always select the correct next section for a completed interview', () => {
            ...
            for (let i = 1; i < expectedSectionSequence.length; i++) {
                ...
                // Navigate to specific section
                const nextSectionResult = navigationService.navigate(testInterview, _cloneDeep(currentSection), 'forward');
                expect(nextSectionResult).toEqual({
...
describe('navigate function, further use cases', () => {
    ...
    describe('test iteration context order', () => {
        ...
        test('random, with random sequence already set', () => {
            ...
            // Navigate to specific section
            const nextSectionResult = navigationService.navigate(testInterviewWithRandomSequence, _cloneDeep(currentSectionData), 'forward');
    ...
    describe('onSectionEntry/Exit', () => {
        ...
        test('Navigating from home to household', () => {
            ...
            const nextSectionResult = navigationService.navigate(testInterview, currentSectionData);
            expect(nextSectionResult).toEqual({
                targetSection: {
                    sectionShortname: expectedSection,
                    iterationContext: undefined
        ...
        test('Entering end section with home as previous', () => {
            ...
            // Navigate to next section
            const nextSectionResult = navigationService.initNavigationState(testInterview, 'end', currentSectionData);
            expect(nextSectionResult).toEqual({
                targetSection: {
                    sectionShortname: expectedSection,
                    iterationContext: undefined
