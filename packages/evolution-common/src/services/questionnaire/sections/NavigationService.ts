...
import { NavigationSection, NavigationState, TargetSectionResult } from '../types/NavigationTypes';
...
export class NavigationService {
    ...
    private findFirstNonSkippedSection(
        ...
        if (this.sections[navigateToSection.sectionShortname].type === 'repeatedBlock') {
    ...
    public initNavigationState(
        ...
        return {
            navigationState: {
                currentSection: { sectionShortname: requestedSection || '', iterationContext: undefined },
                navigationHistory: []
            }
        };
    }
