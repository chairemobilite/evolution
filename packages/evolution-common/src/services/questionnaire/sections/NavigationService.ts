...
export class NavigationService {
    ...
    public navigate(
        ...
        const [targetSection, valuesByPath] = this.findFirstNonSkippedSection(interview, currentSection, direction);
    ...
    public initNavigationState(
        ...
        if (this.isSectionEnabledAndVisible(interview, targetSectionWithContext)) {
            ...
            if (
                ...
                const finalUpdatedValues = this.getValuesToUpdate(interview, targetSectionWithContext);
                return {
