...
describe('BaseVehicle', () => {
    ...
    it('should create a new BaseVehicle instance with minimal attributes', () => {
        const minimalAttributes: BaseVehicleAttributes = { _uuid: validUUID, make: 'Honda' as VAttr.Make, model: 'Civic' as VAttr.Model };
    ...
    it('should accept extended attributes', () => {
        const extendedAttributes: ExtendedVehicleAttributes = { ...baseVehicleAttributes, customAttribute: 'Custom Value' };
    ...
    it('should set weight and method correctly', () => {
        ...
        expect(weight.weight).toBe(0.0001);
    ...
    it('should return an empty array for valid params', () => {
        const params = { _uuid: uuidV4(), make: 'Toyota', model: 'Camry', licensePlateNumber: 'ABC123', capacitySeated: 5, capacityStanding: 0 };
    ...
    it('should return an error for invalid make', () => {
        const params = { _uuid: -34, make: 123, model: 456, licensePlateNumber: {}, capacitySeated: new Date(), capacityStanding: -34.65 };
