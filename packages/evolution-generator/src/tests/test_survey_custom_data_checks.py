...
class TestValidTsIdentifier:
    def test_accepts_simple_name(self):
        assert survey_custom_data_checks.valid_ts_identifier("householdSize") is True
    ...
    def test_rejects_name_with_spaces(self):
        assert survey_custom_data_checks.valid_ts_identifier("household size") is False
