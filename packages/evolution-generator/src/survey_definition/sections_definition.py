...
# same-row checks). The rules across rows (a field unique across the table,
# parent_section naming a real section) live in sheet_checks.py.
#
...
class SectionDefinition(BaseModel):
    ...
    Build instances through `collect_sections_issues` (sheet_checks.py), which
