...
describe('InputButton with normal options', () => {
    ...
    const choices = [
        { value: 'val1', label: { en: 'english value', fr: 'valeur française' }, hidden: false, color: 'green' },
        { value: 'val2', label: 'Unilingual label', iconPath: 'img/test.png', color: 'red', size: 'small' as const },
...
test('Render InputButton with choice function', () => {
    const choices = [
        ...
        { value: 'val2', label: 'Unilingual label', iconPath: 'img/test.png', color: 'red', size: 'small' as const },
        { value: 'hiddenVal', label: { en: 'english hidden', fr: 'cachée' }, hidden: true },
        { value: 'conditionalVal', label: { en: 'english conditional', fr: 'conditionnelle' }, conditional: () => false }
    ];
