...
// Mock db queries
jest.mock('../maps/google/GoogleGeocoder', () => ({ geocodeSinglePoint: jest.fn() }));
        ...
        const testWidgetConfig = Object.assign(
            {
                ...
                icon: { url: 'path/to/icon', size: [20, 20] as [number, number] },
                maxZoom: 18,
                defaultZoom: 15
            },
            baseWidgetConfig
    ...
    const testWidgetConfig = Object.assign(
        {
            ...
            maxZoom: 18,
            defaultZoom: 15,
            placesIcon: { url: 'path/to/icon', size: [60, 60] as [number, number] },
