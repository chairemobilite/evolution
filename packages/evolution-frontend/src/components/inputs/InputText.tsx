...
export interface InputTextProps<Su, Ho, Pe, Pl, Ve, Vp, Tr, Se> {
    id: string;
    ...
    widgetConfig: InputTextType<Su, Ho, Pe, Pl, Ve, Vp, Tr, Se>;
}

export const InputText = <Su, Ho, Pe, Pl, Ve, Vp, Tr, Se>(props: InputTextProps<Su, Ho, Pe, Pl, Ve, Vp, Tr, Se>) => (
    <textarea
        autoComplete="off"
