...
export const validateButtonAction: ButtonAction = (callbacks, _interview, path, _section, _sections, saveCallback) => {
    callbacks.startNavigate(undefined, (updatedInterview) => {
