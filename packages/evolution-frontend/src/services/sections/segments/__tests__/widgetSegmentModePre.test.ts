...
describe('Mode choices labels', () => {
    ...
    each([
        ...
        ['ferry', ['customSurvey:segments:mode:Ferry', 'segments:mode:Ferry']],
...
describe('Mode label', () => {
    ...
    test('should return the right label for first segment', () => {
        ...
        expect(mockedT).toHaveBeenCalledWith(['customSurvey:segments:PremierModeChoix', 'segments:PremierModeChoix'], { 
            context,
            originName,
            destinationName,
            count: 1
    ...
    test('should return another label if segment is not the first', () => {
        ...
        expect(mockedT).toHaveBeenCalledWith(['customSurvey:segments:ModeChoixAutre', 'segments:ModeChoixAutre'], { 
            context,
            originName,
            destinationName,
            count: 1
