...
const SurveyRouter = () => (
  <Switch>
    ...
    <PublicRoute   path="/user/login" component={AdminLoginPage} config={adminLoginConfig}/>
    <PublicRoute   path="/user/register" component={AdminRegisterPage} config={adminLoginConfig}/>
